...
func (r ApiGetCookieDomainsRequest) Execute() (*CookieDomains, *http.Response, error) {
	return r.ApiService.GetCookieDomainsExecute(r)
}
...
*/
func (a *CookieDomainsAPIService) GetCookieDomains(ctx context.Context) ApiGetCookieDomainsRequest {
	return ApiGetCookieDomainsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *CookieDomainsAPIService) internalGetCookieDomainsExecute(r ApiGetCookieDomainsRequest) (*CookieDomains, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CookieDomainsAPIService.GetCookieDomains")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/environment/cookie-domains"
...
func (r ApiSetCookieDomainsRequest) Execute() (*CookieDomains, *http.Response, error) {
	return r.ApiService.SetCookieDomainsExecute(r)
}
...
*/
func (a *CookieDomainsAPIService) SetCookieDomains(ctx context.Context) ApiSetCookieDomainsRequest {
	return ApiSetCookieDomainsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *CookieDomainsAPIService) internalSetCookieDomainsExecute(r ApiSetCookieDomainsRequest) (*CookieDomains, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CookieDomainsAPIService.SetCookieDomains")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
