...
// checks if the PromotionStartLocking type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PromotionStartLocking{}
...
type NullablePromotionStartLocking struct {
	value *PromotionStartLocking
	isSet bool
}

func (v NullablePromotionStartLocking) Get() *PromotionStartLocking {
	return v.value
}

func (v *NullablePromotionStartLocking) Set(val *PromotionStartLocking) {
	v.value = val
	v.isSet = true
}

func (v NullablePromotionStartLocking) IsSet() bool {
	return v.isSet
}
...
func NewNullablePromotionStartLocking(val *PromotionStartLocking) *NullablePromotionStartLocking {
	return &NullablePromotionStartLocking{value: val, isSet: true}
}
