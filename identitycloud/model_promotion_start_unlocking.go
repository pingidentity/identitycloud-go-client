...
// checks if the PromotionStartUnlocking type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PromotionStartUnlocking{}
...
type NullablePromotionStartUnlocking struct {
	value *PromotionStartUnlocking
	isSet bool
}

func (v NullablePromotionStartUnlocking) Get() *PromotionStartUnlocking {
	return v.value
}

func (v *NullablePromotionStartUnlocking) Set(val *PromotionStartUnlocking) {
	v.value = val
	v.isSet = true
}

func (v NullablePromotionStartUnlocking) IsSet() bool {
	return v.isSet
}

func (v *NullablePromotionStartUnlocking) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePromotionStartUnlocking(val *PromotionStartUnlocking) *NullablePromotionStartUnlocking {
	return &NullablePromotionStartUnlocking{value: val, isSet: true}
}
